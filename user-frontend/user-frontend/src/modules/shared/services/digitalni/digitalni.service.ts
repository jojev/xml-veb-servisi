...
export class DigitalniService {
  ...
  getAllDigitalniByJmbg(search: any): Observable<any> {
    var xmlDoc = this.parser.parseFromString(o2x(search), "text/xml");
    var xmlString = this.serializer.serializeToString(xmlDoc);
    return this.http.post<any>("/api/v1/preview/digitalni_sertifikat/search_jmbg", xmlString, {
