...
public class ZahtevZaIzdavanjeSertifikata {
    ...
    protected PotvrdeRef potvrdeRef;
     ...
     *     
     */
    public PotvrdeRef getPotvrdeRef() {
        return potvrdeRef;
    }
     ...
     *     
     */
    public void setPotvrdeRef(PotvrdeRef value) {
    ...
    public static class PotvrdeRef {
        ...
        protected List<PotvrdaId> potvrdaId;
         ...
         * 
         */
        public List<PotvrdaId> getPotvrdaId() {
            if (potvrdaId == null) {
                potvrdaId = new ArrayList<PotvrdaId>();
            }
