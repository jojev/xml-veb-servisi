            ...
            <fo:page-sequence master-reference="report-page">
                <fo:flow flow-name="xsl-region-body">
                    ...
                    <fo:block>
                        ...
                        <fo:block border-bottom="1px dotted black" margin-left="85px" margin-top="-16px" margin-bottom="7px" padding-bottom="-3px"></fo:block>
                    </fo:block>

                    <fo:block>
                        <fo:inline>Датум рођења:</fo:inline>
                        <fo:block border-bottom="1px dotted black" margin-left="80px" margin-top="-16px" margin-bottom="7px" padding-bottom="-3px"></fo:block>
                    </fo:block>

                    <fo:block>
                        <fo:inline>Пол:</fo:inline>
                        <fo:block border-bottom="1px dotted black" margin-left="29px" margin-top="-16px" margin-bottom="7px" padding-bottom="-3px"></fo:block>
                    </fo:block>

                    <fo:block>
                        <fo:inline>Јединствени матични број грађанина:</fo:inline>
                        <fo:block border-bottom="1px dotted black" margin-left="197px" margin-top="-16px" margin-bottom="7px" padding-bottom="-3px"></fo:block>
                    </fo:block>

                    <fo:block margin-bottom="15px">
                        <fo:inline>Број пасоша:</fo:inline>
                        <fo:block border-bottom="1px dotted black" margin-left="72px" margin-top="-16px" margin-bottom="10px" padding-bottom="-3px"></fo:block>
                    </fo:block>

                    <fo:block>
                        <fo:inline>Разлог за подношење захтева:</fo:inline>
                        <fo:block border-bottom="1px dotted black" padding-bottom="-3px"></fo:block>
                    </fo:block>
                    ...
                    <fo:block margin-bottom="20px">
                        У <fo:inline text-decoration="underline"></fo:inline>,
                    </fo:block>

                    <fo:block margin-bottom="20px">
                        <fo:inline>
                            дана <fo:inline text-decoration="underline"></fo:inline> године
                        </fo:inline>
                    </fo:block>
